...
EDITS = [
    # Related work points to this study's results instead of restating them.
    (P("The comparison between label sources is the result from this system"),
